        ...
        <div className="max-w-5xl mx-auto space-y-12 pb-40">
          ...
          {activeTab === 'content' && (
            <div className="space-y-20 animate-fade-in">
              ...
              {/* Fix: Added SECTION: FINAL CTA to allow editing missing fields from components/FinalCTA.tsx */}
              <section className="space-y-6">
                <h2 className="text-2xl font-black uppercase gold-gradient font-title">9. Chamada Final (Final CTA)</h2>
                <div className="p-8 bg-zinc-900/40 rounded-[2.5rem] border border-white/5 space-y-8">
                  <div>
                    <label className="text-[10px] uppercase text-gray-500 font-bold tracking-widest block mb-2">Pergunta de Impacto</label>
                    <input type="text" className="w-full bg-black/40 border border-white/10 p-4 rounded-xl text-white text-sm font-bold" value={tempContent.finalCtaQuestion} onChange={e => setTempContent({...tempContent, finalCtaQuestion: e.target.value})} />
                  </div>
                  <div>
                    <label className="text-[10px] uppercase text-gray-500 font-bold tracking-widest block mb-2">Oferta Principal</label>
                    <input type="text" className="w-full bg-black/40 border border-white/10 p-4 rounded-xl text-white text-sm font-bold" value={tempContent.finalCtaOffer} onChange={e => setTempContent({...tempContent, finalCtaOffer: e.target.value})} />
                  </div>
                  <div>
                    <label className="text-[10px] uppercase text-gray-500 font-bold tracking-widest block mb-2">Caminho/Explicação</label>
                    <textarea className="w-full bg-black/40 border border-white/10 p-4 rounded-xl text-white text-sm h-32 leading-relaxed" value={tempContent.finalCtaPath} onChange={e => setTempContent({...tempContent, finalCtaPath: e.target.value})} />
                  </div>
                  <div>
                    <label className="text-[10px] uppercase text-gray-500 font-bold tracking-widest block mb-2">Texto do Botão</label>
                    <input type="text" className="w-full bg-black/40 border border-white/10 p-4 rounded-xl text-white text-xs font-black uppercase tracking-widest" value={tempContent.finalCtaButton} onChange={e => setTempContent({...tempContent, finalCtaButton: e.target.value})} />
                  </div>
                </div>
              </section>
