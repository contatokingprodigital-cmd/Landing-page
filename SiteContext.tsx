...
const defaultContent: SiteContent = {
  heroTitle: "Sua Empresa No Lugar Certo, e No Momento Certo",
  ...
  pillars: [
    { icon: "📊", title: "Inteligência de Dados", desc: "Não operamos no escuro. Nossas decisões são baseadas em métricas reais e ferramentas de tracking avançadas." },
    { icon: "🎯", title: "Criativos de Alta Retenção", desc: "Desenvolvemos anúncios que param o scroll e obrigam o seu cliente ideal a clicar." },
    { icon: "🚀", title: "Escala Previsível", desc: "Estruturamos funis de vendas preparados para receber investimento agressivo e gerar lucro." },
    { icon: "👑", title: "Gestão de Elite", desc: "Acompanhamento diário por especialistas que entendem de estratégia de negócio." }
  ],
  ...
  services: [
    ...
    { title: "Criação de Criativos de Alta Conversão", description: "Desenvolvemos anúncios magnéticos com copy persuasiva e design focado em parar o scroll do seu cliente ideal." },
    { title: "Funis de Vendas e Landing Pages", description: "Estruturamos a jornada do cliente desde o clique até a conversão final, garantindo que nenhum lead seja desperdiçado." },
    { title: "Análise de Dados e BI", description: "Implementamos rastreamento avançado (API de Conversão, GTM) para que você saiba exatamente de onde vem cada centavo de lucro." }
  ],
